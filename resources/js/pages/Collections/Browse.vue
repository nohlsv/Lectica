                        ...
                        <div class="p-6">
                            ...
                            <div class="flex items-center justify-between gap-2">
                                <Link
                                    ...
                                    class="flex-1 text-center px-3 py-2 bg-indigo-600 text-white text-sm font-medium rounded-md hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-indigo-500"
                                >
                                    View Details
                                </Link>
                                <button
                                    @click="copyCollection(collection)"
                                    class="flex-1 px-3 py-2 bg-blue-600 text-white text-sm font-medium rounded-md hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500"
                                >
...
const search = () => {
    router.get(route('collections.browse'), {
