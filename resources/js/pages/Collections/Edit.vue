                        ...
                        <form @submit.prevent="submit">
                            ...
                            <div class="mb-6">
                                ...
                                <div class="mb-4">
                                    ...
                                    <div class="space-y-2 max-h-48 overflow-y-auto border border-gray-300 dark:border-gray-600 rounded-md p-2">
                                        <div
...
const selectedFiles = computed(() =>
    props.collection.files.filter(file => form.file_ids.includes(file.id))
)

const availableFiles = computed(() =>
    props.userFiles.filter(file => !form.file_ids.includes(file.id))
)
