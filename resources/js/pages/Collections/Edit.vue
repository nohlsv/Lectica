    ...
    <AppLayout>
        ...
        <div class="py-12 bg-gradient min-h-screen">
            <div class="mx-auto max-w-md flex justify-center sm:order-2 sm:flex-1 mb-6 mx-4">
                <h1 class="welcome-banner animate-soft-bounce px-6 py-2 text-center text-2xl leading-tight font-bold pixel-outline">Edit Collection</h1>
            </div>
            <div class="mx-full sm:px-6 lg:px-8">
                <div class="overflow-hidden bg-container shadow-sm sm:rounded-lg mx-4">
                        ...
                        <form @submit.prevent="submit">
                            ...
                            <div class="mb-6">
                                ...
                                <input
                                    ...
                                    v-model="form.name"
                                    type="text"
                                    class="w-full rounded-md border-yellow-500 shadow-sm bg-black/60 px-3 py-2"
                                    required
                                />
                            ...
                            <div class="mb-6">
                                ...
                                <textarea
                                    ...
                                    rows="3"
                                    class="w-full rounded-md border-yellow-300 shadow-sm bg-black/60 px-3 py-2"
                                ></textarea>
                                    ...
                                    <button
                                        ...
                                        :class="
                                            !form.is_public
                                                ...
                                                : 'border-gray-300 bg-black/30 hover:scale-105 transition-transform duration-500 hover:border-gray-300 dark:border-gray-600'
                                        "
                            ...
                            <div class="mb-6">
                                ...
                                <div class="flex">
                                    ...
                                    <button
                                        type="button"
                                        @click="addTag"
                                        class="rounded-r-md bg-indigo-600 px-4 py-2 text-white pixel-outline hover:bg-indigo-700 focus:ring-2 focus:ring-indigo-500 focus:outline-none"
                                    >
                                        Add
                                    </button>
                                </div>
                            ...
                            <!-- File Management -->
                            <div class="mb-6">
                                <label class="mb-2 block text-md font-medium text-gray-300 pixel-outline"> Manage Files </label>
                                <p class="mb-4 text-sm text-gray-400 pixel-outline">
                                    Select and reorder files in your collection. Drag to reorder.
                                </p>

                                <!-- Current Files -->
                                <div class="mb-4">
                                    <h4 class="mb-2 text-md font-medium text-gray-300 pixel-outline">
                                    ...
                                    <div class="max-h-48 space-y-2 overflow-y-auto rounded-md border border-blue-600 bg-black/50 p-2">
                                        ...
                                        >
                                            <div class="flex items-center space-x-2">
                                                <span class="font-mono text-sm text-gray-400 pixel-outline">{{ index + 1 }}.</span>
                                                <span class="text-sm font-medium pixel-outline">
                                                    {{ getFileName(fileId) }}
                                                </span>
                                            </div>
                                            <div class="flex items-center space-x-2">
                                ...
                                <!-- Available Files -->
                                <div>
                                    <h4 class="mb-2 text-md font-medium text-gray-300 pixel-outline">Available Files</h4>
                                    <div class="max-h-48 space-y-2 overflow-y-auto rounded-md border border-green-500 p-2 bg-black/50">
                                        <label
                                        ...
                                        >
                                            <input
                                                ...
                                                class="focus:ring-opacity-50 rounded pixel-outline-icon border-gray-300 text-indigo-600 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200"
                                            />
                                            <div class="flex-1">
                                                <div class="flex items-center justify-between">
                                                    ...
                                                    <span class="text-xs text-gray-400 pixel-outline text-center"> {{ file.quizzes_count || 0 }} questions </span>
                                                </div>
                                            </div>
                                        </label>
                                    </div>
                            ...
                            <div class="flex items-center justify-between">
                                <Link
                                    ...
                                    class="text-red-400 hover:text-red-100 pixel-outline "
                                >
                                    ← Back to Details
                                </Link>
