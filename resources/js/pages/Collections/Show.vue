                    ...
                    <div class="p-6">
                        <div class="grid grid-cols-1 gap-6 lg:grid-cols-3">
                            ...
                            <div class="lg:col-span-2">
                                ...
                                <div
                                    v-if="!collection.is_original && collection.original_creator"
                            ...
                            <div class="space-y-4">
                                <div class="rounded-lg bg-gray-50 p-4 dark:bg-gray-700">
                                    <h3 class="mb-4 text-lg font-medium text-gray-900 dark:text-gray-100">Start Playing</h3>
                                    <div class="space-y-3">
                                        <Link
                ...
                <div class="overflow-hidden bg-white shadow-sm sm:rounded-lg dark:bg-gray-800">
                    <div class="p-6">
                            ...
                            >
                                <div class="flex items-center space-x-4">
                                    <div class="flex-shrink-0">
                                        <span
                                            class="inline-flex h-8 w-8 items-center justify-center rounded-full bg-indigo-100 text-sm font-medium text-indigo-800"
                                        >
                                            {{ index + 1 }}
                                        </span>
                                    </div>
                        ...
                        <div v-else class="py-12 text-center">
                            ...
                            <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">This collection doesn't contain any files yet.</p>
...
const toggleFavorite = async () => {
    try {
        await router.post(
            route('collections.favorite', props.collection.id),
            {},
            {
                preserveScroll: true,
                onSuccess: () => {
