...
<template>
    ...
    <div class="flex h-full flex-1 flex-col gap-4 rounded-xl p-4">
        <AppLayout>
            <h2 class="mt-3 text-lg font-bold break-words sm:text-xl md:text-2xl">Quiz: {{ file.name }}</h2>
            ...
            >
                <!-- Question Box -->
                <div
                    class="font-pixel absolute top-10 right-4 left-4 flex w-auto items-center gap-3 rounded-none border-[6px] border-black bg-white/95 px-3 py-3 shadow-[6px_6px_0px_rgba(0,0,0,1),-3px_-3px_0px_rgba(0,0,0,1)] sm:top-10 sm:left-1/2 sm:max-w-3xl sm:-translate-x-1/2 sm:gap-6 sm:px-6 sm:py-4"
                    style="image-rendering: pixelated"
                >
                    <div
                        class="font-pixel absolute -top-5 left-0 border-2 border-white bg-black px-3 py-1 text-sm text-white shadow-[2px_2px_0px_rgba(0,0,0,0.8)] sm:text-base"
                    >
                        Funko the Pop
                    </div>
                    <div class="flex-1 text-lg text-black sm:text-xl md:text-2xl">"{{ currentQuiz?.question }}"</div>
                ...
                <div
                    class="mb-2 flex min-h-[250px] w-full items-center justify-center rounded-xl bg-[url(/8-bit-bg.png)] bg-cover bg-center p-6"
                ></div>
                        ...
                        <CardContent class="space-y-4">
                            <div class="flex flex-col items-center justify-center text-center">
                                ...
                                <p class="mt-4 text-xl">
                                    You got <span class="font-bold">{{ score.correct }}</span> out of
                                    <span class="font-bold">{{ score.total }}</span> questions correct.
                                </p>
                                <div class="mt-6">
                    ...
                    <Card class="min-h-[300px]" v-if="currentQuiz">
                        ...
                        <CardContent>
                            ...
                            <div v-else-if="currentQuiz.type === 'enumeration'" class="w-full space-y-4">
                                <p
                                    class="rounded-lg border-4 border-green-700 bg-green-500 px-4 py-2 text-sm font-bold text-white shadow-[4px_4px_0px_rgba(0,0,0,0.4)]"
                                >
                                ...
                                <div v-for="(answer, index) in userAnswers[currentIndex]" :key="index" class="w-full">
                                    ...
                                    >
                                        ...
                                        <Input
                                            ...
                                            class="placeholder-opacity-60 flex-1 border-none bg-transparent text-center placeholder-yellow-400 outline-none focus:animate-bounce"
                                        />
                                        <span
