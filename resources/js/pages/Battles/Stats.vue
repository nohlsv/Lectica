        ...
        <div class="py-12">
            <div class="mx-auto max-w-7xl sm:px-6 lg:px-8">
                ...
                <div class="mb-8 grid grid-cols-1 gap-6 md:grid-cols-2">
                    <div class="overflow-hidden bg-white shadow-sm sm:rounded-lg dark:bg-gray-800">
                        <div class="p-6">
                            <h3 class="mb-4 text-lg font-semibold text-gray-900 dark:text-gray-100">Win Rate</h3>
                    ...
                    <div class="overflow-hidden bg-white shadow-sm sm:rounded-lg dark:bg-gray-800">
                        <div class="p-6">
                            <h3 class="mb-4 text-lg font-semibold text-gray-900 dark:text-gray-100">Answer Accuracy</h3>
                            <div class="flex items-center">
                                <div class="mr-4 h-4 flex-1 rounded-full bg-gray-200">
                                    <div
                ...
                <div class="overflow-hidden bg-white shadow-sm sm:rounded-lg dark:bg-gray-800">
                    <div class="p-6">
                        <h3 class="mb-4 text-lg font-semibold text-gray-900 dark:text-gray-100">Recent Battles</h3>
                ...
                <div class="mt-8 text-center">
                    <Link :href="route('battles.create')" class="mr-4 rounded-lg bg-green-500 px-6 py-3 font-bold text-white hover:bg-green-700">
                        Start New Battle
                    </Link>
                    <Link :href="route('battles.index')" class="rounded-lg bg-blue-500 px-6 py-3 font-bold text-white hover:bg-blue-700">
                        View All Battles
                    </Link>
                </div>
            </div>
