<template>
    <AppLayout title="Battle Answers">
        <template #header>
            <div class="flex items-center justify-between">
                <h2 class="font-semibold text-xl text-white leading-tight">
                    Battle Answer History
                </h2>
                <Link 
                        ...
                        <div class="flex items-center justify-between mb-4">
                            <div>
                                <h3 class="text-lg font-semibold text-white">
                                    Battle vs {{ battle.monster.name }}
                                </h3>
                                <p class="text-sm text-gray-300">
                                    {{ battle.file ? 'File: ' + battle.file.name : 'Collection: ' + battle.collection.name }}
                                </p>
                            </div>
                            <div class="text-right">
                                <span 
                                    class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium"
                                    :class="getBattleStatusClass(battle.status)"
                                >
                        ...
                        <div class="space-y-4">
                            ...
                            <div v-if="answers.length === 0" class="text-center py-8">
                                <div class="text-gray-400">
                                    ...
                                    <p class="mt-1 text-sm text-gray-400">This battle has no recorded quiz answers.</p>
                                </div>
                            </div>
                        </div>
                    </div>
