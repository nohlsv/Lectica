    ...
    <AppLayout>
        <template #header>
            <div class="flex items-center justify-between">
                <h2 class="text-xl leading-tight font-semibold text-gray-800 dark:text-gray-200">My Multiplayer Games</h2>
        ...
        <div class="py-12">
            <div class="mx-auto max-w-7xl sm:px-6 lg:px-8">
                <!-- Games Grid -->
                <div v-if="games.data.length > 0" class="grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-3">
                    <div
                        ...
                        <div class="p-6">
                            ...
                            <div class="mb-4 flex items-start justify-between">
                                <div class="flex-1">
                                    <div class="mb-2 flex items-center gap-2">
                                        <img :src="game.monster.image" :alt="game.monster.name" class="h-8 w-8 rounded-full" />
                                        <h3 class="text-lg font-medium text-gray-900 dark:text-gray-100">vs {{ game.monster.name }}</h3>
                                        <span
                            ...
                            <div class="mb-4">
                                <div class="flex items-center justify-between text-sm">
                                    ...
                                    <div class="flex items-center space-x-2">
                                        ...
                                        <span v-if="game.playerTwo"> {{ game.playerTwo.first_name }} {{ game.playerTwo.last_name }} </span>
                            ...
                            <div v-if="game.total_questions_p1 > 0 || game.total_questions_p2 > 0" class="mb-4">
                                <div class="text-xs text-gray-500 dark:text-gray-400">
                                    <div>
                                        {{ game.playerOne.first_name }}: {{ getAccuracy(game.correct_answers_p1, game.total_questions_p1) }}% accuracy
                                    </div>
