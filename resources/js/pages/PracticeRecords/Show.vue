                ...
                <div class="pixel-outline rounded-lg border-2 border-[#0c0a03] bg-[#8E2C38] p-4">
                    ...
                    <div class="mt-4">
                        <Link
                            ...
                            "
                            class="pixel-outline inline-block rounded-md border-2 border-[#0c0a03] bg-[#10B981] px-4 py-2 text-base font-semibold tracking-wide text-white duration-300 hover:scale-105 hover:bg-[#0e9459]"
                        >
